...
?>
        ...
        <section class="index-categories mb-4">
            <h2>Choose from these Categories</h2>
            
            <div class="index-categories-list row">
                <div class="card text-center m-auto" style="width: 18rem; height: 10rem;">
                    <h4 class="card-body">Category 1</h4>
                </div>
                <div class="card text-center m-auto" style="width: 18rem; height: 10rem;">
                    <h4 class="card-body">Category 2</h4>
                </div>
                <div class="card text-center m-auto" style="width: 18rem; height: 10rem;">
                    <h4 class="card-body">Category 3</h4>
                </div>
            </div>
        </section>
